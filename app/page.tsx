...
const pressItems = [
  {
    ...
    quote: "Chef Patrick Capuozzo brings his Michael Symon-trained expertise to Solon's dining scene",
  },
  {
  ...
  return (
    <>
      <HeroBanner
        ...
        subtext="Experience Chef Adam Brooks' Mediterranean-inspired cuisine featuring fresh, seasonal dishes with an Italian foundation. Every dish prepared from scratch with love in our Bohemian chic atmosphere."
        primaryCTA={{
      ...
      <section className="py-s-24 bohemian-tapestry relative overflow-hidden">
        ...
        <div className="max-w-6xl mx-auto px-s-6 relative z-10">
          <div className="text-center mb-s-16">
            ...
            <h2 className="text-h2 font-display text-accent-1 mb-4 bohemian-text-shadow">Artisan Creations</h2>
            <p className="accent-text text-xl italic">~ Where tradition meets wanderlust ~</p>
            <div className="bohemian-divider mx-auto mt-6"></div>
          </div>
          
          <div className="grid grid-cols-1 md:grid-cols-3 gap-s-10">
            ...
            <div className="bohemian-card group" style={{animationDelay: '0.2s'}}>
              ...
              <div className="bohemian-tag">Chef's Signature</div>
            </div>
      ...
      {/* Bohemian Explorer's Guide */}
      <section className="py-s-32 bohemian-explorer-bg relative overflow-hidden">
        <div className="absolute inset-0 bohemian-explorer-pattern opacity-8"></div>
        <div className="absolute top-20 left-20 text-accent-1/10 text-8xl font-display rotate-45 hidden xl:block">🍷</div>
        <div className="absolute bottom-16 right-16 text-accent-warm/10 text-9xl font-display -rotate-12 hidden xl:block">🌿</div>
        
        <div className="max-w-7xl mx-auto px-s-6 relative z-10">
          <div className="text-center mb-s-24 fade-in-up">
            <div className="mb-8 flex justify-center">
              <div className="relative w-32 h-32 rounded-full overflow-hidden border-4 border-accent-1/30 shadow-2xl">
                <img 
                  src={contentData.images.hero} 
                  alt="Bohemian woman artwork" 
                  className="w-full h-full object-cover hover:scale-110 transition-transform duration-700"
                />
                <div className="absolute inset-0 bg-gradient-to-t from-accent-1/20 to-transparent"></div>
              </div>
            </div>
            <span className="accent-text text-2xl mb-6 block bohemian-script">~ Journey of the Senses ~</span>
            <h2 className="text-h2 font-display mb-6 bohemian-text-shadow">An Unforgettable Culinary Odyssey</h2>
            <div className="bohemian-journey-divider mx-auto mb-8"></div>
            <p className="text-ink max-w-4xl mx-auto text-lg leading-relaxed">
              Every dish tells a story of fresh, seasonal ingredients prepared from scratch with love. Discover Chef Adam Brooks' Mediterranean-inspired creations that honor traditional Italian foundations while embracing modern culinary innovation in our bohemian sanctuary.
            </p>
          </div>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-s-12">
            <div className="bohemian-exploration-tile group">
              <FeatureTile
                ...
                href="/menu"
              />
              <div className="bohemian-tile-ornament">
                <span className="text-accent-1 text-sm italic">Culinary Adventures</span>
              </div>
            </div>
            ...
            <div className="bohemian-exploration-tile group" style={{animationDelay: '0.2s'}}>
              ...
              />
              <div className="bohemian-tile-ornament">
                <span className="text-accent-1 text-sm italic">Liquid Poetry</span>
              </div>
            </div>
          </div>
        </div>
      ...
      {/* Bohemian Chef's Journey */}
      <section className="py-s-32 bohemian-story-bg relative overflow-hidden">
        <div className="absolute inset-0 bohemian-story-pattern opacity-5"></div>
        <div className="absolute top-16 right-16 text-accent-1/10 text-9xl font-display rotate-12 hidden xl:block">🍃</div>
        <div className="absolute bottom-20 left-20 text-accent-warm/10 text-7xl font-display -rotate-12 hidden xl:block">✨</div>
        
        <div className="max-w-6xl mx-auto px-s-6 relative z-10">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-s-20 items-center">
            <div className="order-2 lg:order-1 fade-in-up">
              <div className="bohemian-story-ornament mb-6"></div>
              <span className="accent-text text-2xl mb-4 block bohemian-script">~ Mediterranean Artisan ~</span>
              <h2 className="text-h2 font-display text-accent-1 mb-6 bohemian-text-shadow">Chef Adam Brooks</h2>
              <div className="bohemian-flourish-line mb-8"></div>
              
              <p className="text-ink mb-6 leading-relaxed text-lg">
                Chef Adam Brooks brings a fresh Mediterranean perspective to Elle, crafting innovative dishes that honor traditional Italian foundations while embracing seasonal, local ingredients.
              </p>
              ...
              <div className="bohemian-quote-box mb-8">
                ...
                <p className="accent-text text-lg italic leading-relaxed">
                  Every dish is created from scratch with love, using the freshest ingredients to bring bright, seasonal flavors that celebrate the Mediterranean spirit.
                </p>
                <div className="bohemian-quote-attribution">~ Chef Adam Brooks</div>
              </div>
              
              <p className="text-muted-ink mb-8 leading-relaxed">
                At Elle, Chef Brooks continues the restaurant's commitment to excellence, creating new amazing dishes that reflect the restaurant's philosophy of honoring the maternal, womanly essence through nurturing, carefully crafted cuisine.
              </p>
              
              <div className="bohemian-signature-line">
                <div className="bohemian-flourish-left"></div>
                <span className="accent-text italic px-4">"Made from scratch with love"</span>
                ...
                <div className="bohemian-frame">
                  <div className="bohemian-photo-wrapper">
                    <img 
                      ...
                      alt="Chef Patrick Capuozzo - Bohemian culinary artist"
      ...
      {/* Atmosphere Teaser */}
      <section className="py-s-24 bg-secondary-bg/30">
        <div className="max-w-4xl mx-auto px-s-6 text-center">
          <h2 className="text-h2 font-display font-light mb-8 text-accent-1">The Elle Experience</h2>
          <p className="text-lg text-ink mb-12 leading-relaxed">
          ...
          <div className="grid grid-cols-2 md:grid-cols-4 gap-s-8">
      ...
      <JoinCTA
        ...
        blurb="Experience the sophisticated dining destination in the heart of Cleveland's eastern suburbs. From Chef Adam Brooks' wood-fired creations to our craft cocktails, Elle offers a refined yet warm and welcoming atmosphere perfect for any occasion."
        button={{
      ...
      <section className="py-s-24 bg-gradient-to-br from-accent-1/5 to-accent-warm/5 relative overflow-hidden">
        <div className="absolute inset-0 bohemian-pattern opacity-5"></div>
        <div className="max-w-6xl mx-auto px-s-6 relative z-10">
          <div className="text-center mb-s-16">
            <div className="bohemian-border-ornament mx-auto mb-4"></div>
            <h2 className="text-h2 font-display text-accent-1 mb-4 bohemian-text-shadow">Tonight's Culinary Highlights</h2>
            <p className="accent-text text-xl italic">~ From Our Mediterranean Kitchen ~</p>
            <div className="bohemian-divider mx-auto mt-6"></div>
          </div>
          
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-s-8">
            <div className="bohemian-card group text-center">
              ...
              <div className="flex justify-between items-center">
                <div className="bohemian-tag">Chef's Pride</div>
      ...
      <div className="fixed bottom-6 right-6 z-40 hidden lg:block">
        <div className="bg-gradient-to-br from-accent-1 to-accent-warm text-white p-4 rounded-2xl shadow-elegant appetizing-hover cursor-pointer max-w-xs animate-float border-2 border-accent-1/50">
          <div className="flex items-center space-x-3">
            ...
            <div>
              <p className="font-bold text-sm">Happy Hour Special!</p>
              <p className="text-xs opacity-90">Elle Burger & Truffle Frites</p>
              <p className="text-xs mt-1 text-amber-200">Tue-Thu 4-6pm</p>
            </div>
          </div>
